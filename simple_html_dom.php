...
class simple_html_dom_node {
    ...
    function outertext()
    {
        ...
        if (isset($this->_[HDOM_INFO_TEXT])) return !empty($this->dom)?$this->dom->restore_noise($this->_[HDOM_INFO_TEXT]):'';
        // render begin tag
    ...
    function makeup()
    {
        ...
        $ret = '<'.$this->tag;
        $i = -1;
		if(is_object($this->attr) || is_array($this->attr))
